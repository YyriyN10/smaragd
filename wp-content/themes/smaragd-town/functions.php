...
function smaragd_town_scripts() {
	...
	wp_style_add_data( 'smaragd-town-style', 'rtl', 'replace' );

	wp_enqueue_script( 'smaragd-town-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
